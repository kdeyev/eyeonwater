...
from homeassistant.const import CONF_ADDRESS, DEVICE_CLASS_ENERGY
...
async def async_setup_entry(hass, config_entry, async_add_entities):
    ...
    async_add_entities(
        [EyeOnWaterSensor(meter, coordinator) for meter in meters], False
    )
...
class EyeOnWaterSensor(CoordinatorEntity, RestoreEntity, SensorEntity):
    ...
    def extra_state_attributes(self):
        ...
        attributes = {
            METER_NUMBER: self.meter.meter_id,
